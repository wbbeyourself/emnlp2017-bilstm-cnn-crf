...
def compute_f1_of_token(predictions, correct, O_Label):
    prec = compute_precision_of_token(predictions, correct, O_Label)
    rec = compute_precision_of_token(correct, predictions, O_Label)
...
def compute_precision_of_token(guessed_sentences, correct_sentences, O_Label):
    assert (len(guessed_sentences) == len(correct_sentences))
    correctCount = 0
    count = 0
